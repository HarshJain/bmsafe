...
#include <MC9S12XDP512.h>              /* I/O map for MC9S12XDP512BMFV */
#include "MCUinit.h"
...
/*
** ===================================================================
**     Method      :  MCU_init_reset (component MC9S12XDP512_144)
**
**     Description :
...
void MCU_init(void)
{
  ...
  /* ### MC9S12XDP512_144 "Cpu" init code ... */
  ...
  INT_CFDATA1 = 1U;                    /*  0x41  0xFF82   1   no   ivViic1       unused by PE */
  ...
  /* MODRR: MODRR5=1,MODRR0=1 */
  MODRR |= (unsigned char)33U;                      
  ...
  PERT = 255U;                                      
  /* PER1AD1: PER1AD115=1,PER1AD114=1,PER1AD113=1,PER1AD112=1 */
  PER1AD1 |= (unsigned char)240U;                      
  /* PER0AD1: PER0AD123=1,PER0AD122=1,PER0AD121=1,PER0AD120=1,PER0AD119=1,PER0AD118=1,PER0AD117=1,PER0AD116=1 */
  PER0AD1 = 255U;                                      
  /* PERM: PERM7=1,PERM6=1,PERM5=1,PERM4=1,PERM1=1,PERM0=1 */
  PERM |= (unsigned char)243U;                      
  /* RDRS: RDRS7=1,RDRS6=1,RDRS5=1,RDRS4=1,RDRS3=1,RDRS2=1,RDRS1=1,RDRS0=1 */
  RDRS = 255U;                                      
  /* IRQCR: IRQEN=0 */
  ...
  PITLD0 = 3124U;                            
  /* PITLD1: PLD15=0,PLD14=0,PLD13=0,PLD12=0,PLD11=0,PLD10=0,PLD9=0,PLD8=0,PLD7=0,PLD6=0,PLD5=0,PLD4=0,PLD3=0,PLD2=0,PLD1=0,PLD0=1 */
  PITLD1 = 1U;                            
  /* PITLD2: PLD15=0,PLD14=0,PLD13=0,PLD12=0,PLD11=0,PLD10=0,PLD9=0,PLD8=0,PLD7=0,PLD6=0,PLD5=0,PLD4=1,PLD3=1,PLD2=1,PLD1=1,PLD0=0 */
  PITLD2 = 30U;                            
  ...
  /* ATD1DIEN: IEN15=0,IEN14=0,IEN13=0,IEN12=0,IEN11=0,IEN10=0,IEN9=0,IEN8=0,IEN7=0,IEN6=0,IEN5=0,IEN4=0,IEN3=1,IEN2=1,IEN1=0,IEN0=0 */
  ATD1DIEN = 12U;                            
...
__interrupt void iPIT2_1kHz(void)
{
  ...
  PITTF_PTF2 = 1; // Reset interrupt flag
...
{
	// PIT1 : Fréquence de 15.625 kHz <=> période de 64 us
	
	ATD0CTL5_CA = 0; 	//start ADC0 conversion (from AN0 to AN7)
	ATD1CTL5_CA = 0;  	//start ADC1 conversion (from AN8 to AN11)

	PITCE_PCE1 = 0;		// Désactivation du timer PIT1
	PITTF_PTF1 = 1;  	//reset the interrupt flag
...
{
   ATD1STAT0_SCF = 1; 		// Clear the sequece complete flag
   ATD1CTL2_ADPU = 0;		// On ferme le ADC pour l'économie d'énergie
   gFlags.ADC1done = 1; 	// L'ADC 1 a terminée : on est prêt à aller récupérer les données
}
...
__interrupt void iADC0_seq_complete(void)
{
    ...
    ATD0CTL2_ADPU = 0;		// On ferme le ADC pour l'économie d'énergie
	gFlags.ADC0done = 1; 	// L'ADC0 a terminé les conversions : on est prêt à récupérer les données
}
...
/*lint -restore Enable MISRA rule (1.1) checking. */
  ...
  &iPIT2_1kHz,                          /* 0x3B  0xFF76   1   no   ivVpit2       used by PE */
  &iPIT1_16kHz,                         /* 0x3C  0xFF78   3   no   ivVpit1       used by PE */
  &iPIT0_10Hz,                          /* 0x3D  0xFF7A   2   no   ivVpit0       used by PE */
